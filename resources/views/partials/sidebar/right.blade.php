<div class="px-3 py-4 overflow-y-auto bg-white rounded-xl dark:bg-gray-800">
    <ul class="hidden space-y-2 font-mono md:block">
        ...
        <li @if(url()->current()==route('users.list')) class="bg-gray-100 rounded-md shadow" @endif>
            <a href="{{ route('users.list') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    {{-- Mobile menu --}}
    <ul class="block space-y-2 md:hidden">
        <li @if(url()->current()==route('dashboard')) class="bg-gray-100 rounded-md shadow" @endif>
            <a href="{{ route('dashboard') }}" class="mobile-menu">
        ...
        <li @if(url()->current()==route('users.list')) class="bg-gray-100 rounded-md shadow" @endif>
            <a href="{{ route('users.list') }}" class="mobile-menu">
            <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
            </a>
        </li>
        <li>
...
<div class="justify-center hidden gap-3 px-3 py-4 mb-4 overflow-y-auto text-center bg-white md:block rounded-xl dark:bg-gray-800">
